...
public class WeatherController {
	...
	@ApiOperation(value = "Find daily average weather for the given city on a given day", notes = "Returns daily average weather for the city")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success"),
			@ApiResponse(code = 404, message = "Not Found"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	...
	@RequestMapping(method = RequestMethod.GET, value = URI.HOURLYAVERAGE)
	@ApiOperation(value = "Find hourly average weather for the given city on a given date and time", notes = "Returns hourly average weather for the given city, date and time")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success"),
			@ApiResponse(code = 404, message = "Not Found"),
			@ApiResponse(code = 500, message = "Internal Server Error"), })
	public String findHourlyAverage(@PathVariable("city") String city, @PathVariable("date") String date, @PathVariable("time") String time) {
		return service.findHourlyAverage(city,date,time);
	}
